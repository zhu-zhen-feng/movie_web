    ...
    $(".search").submit(function (e){
        ...
        if (resp.errno == "0") {
            ...
            for (var i=0;i<resp.data.video_dict_li.length;i++) {
                ...
                var content = '<li>'
                content += '<a href="/videos/'+video.id+'" systemidvaule="'+video.id+'" class="video_pic fr"><img src="../../static/uploads/'+ video.img_url +'"></a>'
                content += '<div class="con_box"><a href="/videos/'+video.id+'"systemidvaule="'+video.id+'"><h3>'+ video.intro+'</h3></a>'
